...
(() => {
    ...
    const layoutBase = {
        ...
        font: { family: "DM Sans, sans-serif", color: "#9aa7b5", size: 12 },
        xaxis: { gridcolor: "#1c2530", zerolinecolor: "#1c2530", linecolor: "#2a3340" },
        yaxis: { gridcolor: "#1c2530", zerolinecolor: "#1c2530", linecolor: "#2a3340" },
        margin: { l: 50, r: 24, t: 28, b: 40 },
        legend: { bgcolor: "rgba(0,0,0,0)", font: { color: "#9aa7b5" } },
        hovermode: "closest",
        hoverlabel: { bgcolor: "#1b2430", bordercolor: "#2a3340", font: { family: "DM Sans, sans-serif", color: "#e9eef4" } },
    };
        ...
        Plotly.react(el, [
            {
                ...
                line: { color: "#34a9e6", width: 2.5, shape: "spline", smoothing: 0.6 },
                marker: { size: 9, color: colors, line: { color: "#0b0f15", width: 1.5 } },
                fill: "tozeroy", fillcolor: "rgba(52,169,230,0.06)",
    ...
    function renderFlagHeatmap(heatmap) {
        ...
        const colorMap = { rise: "#3ecf8e", stable: "#34a9e6", drop: "#f06a6a", insufficient_history: "#2a3340" };
